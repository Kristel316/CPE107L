...
<head>
	...
	<!-- [ PLUGIN STYLESHEET ]
        =========================================================================================================================-->
	<link rel="shortcut icon" type="image/x-icon" href="images/b_white1.jpg">
    ...
    <nav  class="amd-menu navbar navbar-default navbar-fixed-top theme_background_color fadeInDown">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <img class ="navbar-brand" src="images/b_white1.jgp">
            <a class="navbar-brand" href="index-user.php">Baqala</a>
        </div>
      ...
      <div class="container">
          <div class="row">
              <div class="col-md-12 text-center">
                 <h1 class="text-capitalize bigFont" data-scroll-reveal="wait 0.45s, then enter top and move 80px over 1s">Discover the Baqala</h1>
              </div>
          </div>
      </div>
    </div>
                ...
                <div class="col-md-12 app-board">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade in active" id="userexperience">
                            ...
                            <p class="text-center">
                                <a href="user-products.php" class="btn btn-primary btn-outline-rounded theme_background_color"> View our Products <span
                        ...
                        <div class="tab-pane fade" id="profile">
                            ...
                            <p class="text-center">
                                <a href="user-products.php" class="btn btn-success btn-outline-rounded theme_background_color"> View our Products <span
                                        class="fa fa-send-o"></span></a>
                            </p>
                        </div>
