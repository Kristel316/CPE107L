              ...
              <input type="hidden" name="command" />
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-search fa-fw"></i> Product Search Results</h3>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            include_once "connect.php";
                                            $conn = OpenConnection();
                                            $sql="SELECT * FROM tbl_products WHERE (Model LIKE '%{$model}%' OR Description LIKE '%{$model}%' OR Type LIKE '%{$model}%') ";
                                            //echo $sql;
                                            ...
                                            if(mysqli_num_rows($result)>=1){
                                                ...
                                                echo "<tr style='color:black';>";
                                                echo "<td colspan='7' align='center'><br><h2>No Product Found</h2><br></td>";
                                            }
